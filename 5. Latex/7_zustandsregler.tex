...
\begin{figure}[H]
   \centering
   \fbox{\includegraphics[width=0.8\textwidth]{Bilder/7_zustandsregler/Polstellen_der_Systemmatrix.pdf}}
...
%\begin{figure}[H]
 %  \centering
 %  \fbox{\includegraphics[width=0.95\textwidth]{Bilder/7_zustandsregler/Reglerstruktur_Simulink.pdf}}
...
\begin{figure}[H]
   \centering
   \fbox{\includegraphics[width=0.8\textwidth]{Bilder/7_zustandsregler/Vergleich_der_Polstellenlagen.pdf}}
...
\begin{figure}[H]
   \centering
   \fbox{\includegraphics[width=0.95\textwidth]{Bilder/7_zustandsregler/Validierung_des_Reglers.pdf}}
...
\begin{figure}[H]
   \centering
   \fbox{\includegraphics[width=0.95\textwidth]{Bilder/7_zustandsregler/Anwendung_des_Reglers.pdf}}
