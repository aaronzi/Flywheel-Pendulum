...
\usepackage{epstopdf}
\usepackage{caption}
\captionsetup[subfigure]{list=true, font=footnotesize, labelformat=brace, position=top}
\usepackage{subcaption}
\usepackage{rotating}
\usepackage{lscape}
\numberwithin{figure}{section}
\captionsetup[subfigure]{list=true, font=footnotesize, labelformat=brace, position=top} %setup für subfigure captions
...
\begin{titlepage}
   ...
   \begin{tabular}{l l}
      ...
      \textbf{Abgabe am:}     & 30.\xspace September 2022                               \\ 
   \end{tabular}
\end{titlepage}
\clearpage
...
\include{2_modellierung}
\include{3_zustandsraummodell}
\include{4_vergleich}
\include{5_sensitivitaetsanalyse}
\include{6_aufschwingen}
\include{7_zustandsregler}
\include{8_beobachterentwurf}
\include{9_ausblick}
...
\bibitem[\the\Quellennummer]{SwingUp}
K. J. Åström and K. Furuta, SWINGING UP A PENDULUM BY ENERGY CONTROL\par
\url{https://doi.org/10.1016/S1474-6670(17)57951-3} \par
 Stand: 21.09.2022 um 15:19 Uhr
